...
export const importDataSource = async (dataSource) => { 
  ...
  let componentsTree = projectSchema[0].componentsTree;
  
  // 找到目标组件
  const targetComponent = componentsTree.children.find(component => component.componentName === "MaterialTableRubber");
