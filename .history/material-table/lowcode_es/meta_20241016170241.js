...
import MaterialTableRubberMeta from 'F:/Mywebsites/lowcode-form-table/material-table/lowcode/material-table-rubber/meta';
import MaterialTableMeta from 'F:/Mywebsites/lowcode-form-table/material-table/lowcode/material-table/meta';
...
function fillRealVersion(meta, packageName, version, basicLibraryVersion) {
  if (packageName === void 0) {
    packageName = 'material-table-rubber';
  }
  if (version === void 0) {
    version = '0.1.0';
  }
...
var componentMetas = [MaterialTableRubberMeta, MaterialTableMeta];
var components = [];
var npmInfo = {};
...
if (!execCompile) {
  window.MaterialTableRubberMeta = {
